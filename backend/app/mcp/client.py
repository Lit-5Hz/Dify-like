...
def initialize_mcp_server(server_url: str, auth_type: str, auth_secret: str = "") -> dict[str, Any]:
...
def list_mcp_tools(server_url: str, auth_type: str, auth_secret: str = "") -> list[dict[str, Any]]:
...
def _post_jsonrpc(
    ...
    try:
        with httpx.Client(timeout=DEFAULT_MCP_TIMEOUT) as client:
